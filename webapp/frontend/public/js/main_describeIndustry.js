var words = ['Drones', 'Robotics', 'Space', 'Sustainability', 'Gaming', 'Healthcare', 'Data', 
    'Artificial Intelligence', 'Bioprinting', 'Automotive', 'Data Science', 'Internet Of Things', 'Lifestyle',
    'Manufacturing', 'Mapping', 'Mixed Reality', 'Networking', 'Sensors',
    'Shipping', 'Transport', 'Virtual Reality', 'County Governance', 'Laboratory', 
