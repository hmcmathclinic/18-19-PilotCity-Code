$(document).ready(function () {
    ...
    (function () {
        ...
        $('#add-row').click(function (event) {
            ...
            $('#real-table').append('<tr><td style="width:40%"><input type="text" placeholder="Employer Address" class = "course-name"/></td><td style="width:10%"><input type="text" placeholder="Type" class = "duration"/></td></tr>');
